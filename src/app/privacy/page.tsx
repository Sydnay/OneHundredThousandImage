    ...
    <main className="max-w-2xl mx-auto px-6 py-12 text-zinc-800">
      ...
      <section className="space-y-6 text-sm leading-relaxed">
        ...
        <div>
          ...
          <p className="mt-2">Чтобы лайки клеток нельзя было накручивать, при нажатии «нравится» мы
          вычисляем технический отпечаток браузера и сохраняем хэш IP-адреса. Сам IP-адрес и отпечаток
          в исходном виде не хранятся.</p>
        </div>
