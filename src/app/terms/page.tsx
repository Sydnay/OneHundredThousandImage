    ...
    <main className="max-w-2xl mx-auto px-6 py-12 text-zinc-800">
      ...
      <section className="space-y-6 text-sm leading-relaxed">
        ...
        <div>
          ...
          в момент появления области на сайте. Чек самозанятого (НПД) формируется Исполнителем
          в сервисе ФНС «Мой налог» и направляется Заказчику на указанный email.</p>
        </div>
